...
const FileUploader = ({
  ...
  <div className="flex justify-center items-center w-[700px] h-full">
    <div className="flex justify-center items-center w-[535px] h-full">
      <div className="shadow-xl bg-white hover:bg-zinc-50 hover:shadow-2xl items-center rounded-xl p-4 w-full">
        <div
          ...
          } hover:border-blue-500 hover:bg-blue-100`} // Applying hover effects with Tailwind classes
          style={{
            background: `url(${DashedBorder}) no-repeat center center`, // Using SVG as background
            backgroundSize: 'cover', // Ensure full SVG is visible
          }}
        ...
        >
          <div className="flex flex-col items-center justify-center">
            ...
            <button
              className="py-3 px-6 bg-[#2C5FF1] w-[260px] text-xl text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 flex items-center justify-center mt-8"
              type="button"
            >
              <img
                src={UploadWhite}
