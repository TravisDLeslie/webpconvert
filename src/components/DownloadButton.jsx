...
const DownloadButton = ({
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center md:justify-end items-center w-full md:w-[610px] mx-auto px-8 py-4">
      ...
      <div className="flex flex-col items-center text-center">
        <p className="text-[#1e1e1e] mb-2 order-1 md:order-none">File didn't download?</p>
        <button
